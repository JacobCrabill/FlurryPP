...
R2 = 75;  // Radius of outer sphere
NN = 6;  // Number of cells in each direction on each spherical surface
NL = 20;  // Number of cells going outwards
prog1 = 1.32;  // Geometric progression factor for layer width
// NN=8, NL=32, prog1=1.18
