...
public :
  ...
  void searchADT_box(MeshBlock *mb, std::unordered_set<int>& icells, double *bbox);
};
...
void searchBoxIntersections(MeshBlock *mb, std::unordered_set<int>& icells, int *adtIntegers, double *adtReals, double *coord, int level, int node, double *bbox, int nelem, int ndim);
